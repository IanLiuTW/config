  ...
  config = function() -- This is the function that runs, AFTER loading
    ...
    require('which-key').add {
      ...
      -- Normal Mode
      {
        ...
        { '<A-d>',            '<C-w><C-o>',                                noremap = true,              silent = true,  desc = 'Pane close other panes' },
        ...
        { '<A-x>',            '<C-w><C-x>',                                noremap = true,              silent = true,  desc = 'Pane swap windows' },
        { '<A-q>',            '<C-w><C-q>',                                noremap = true,              silent = true,  desc = 'Pane quit' },
        { '<A-Right>',        '3<C-w><C->>',                               noremap = true,              silent = true,  desc = 'Pane increase width' },
        { '<A-Left>',         '3<C-w><C-<>',                               noremap = true,              silent = true,  desc = 'Pane decrease width' },
