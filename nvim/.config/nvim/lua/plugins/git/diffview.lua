    ...
    require('diffview').setup {
      ...
      keymaps = {
        ...
        view = {
          ...
          { 'n', ']c', actions.select_next_entry, { desc = 'Open the diff for the next file' } },
          { 'n', '[c', actions.select_prev_entry, { desc = 'Open the diff for the previous file' } },
          ...
          { 'n', '<leader>gu', actions.conflict_choose 'base', { desc = 'Choose the BASE version of a conflict' } },
          ...
          { 'n', '<leader>gU', actions.conflict_choose_all 'base', { desc = 'Choose the BASE version of a conflict for the whole file' } },
          ...
          { 'n', 'q', ':DiffviewFocusFiles<cr>', { desc = 'Close the diffview' } },
          ['<leader>co'] = false,
          ['<leader>ct'] = false,
          ['<leader>cb'] = false,
          ['<leader>ca'] = false,
        ...
        file_panel = {
          ...
          { 'n', '<leader>gA', actions.conflict_choose_all 'all', { desc = 'Choose all the versions of a conflict for the whole file' } },
          { 'n', 'dX', actions.conflict_choose_all 'none', { desc = 'Delete the conflict region for the whole file' } },
          { 'n', 'q', ':DiffviewClose<cr>', { desc = 'Close the diffview' } },
          ['<leader>cO'] = false,
          ['<leader>cT'] = false,
          ['<leader>cB'] = false,
          ['<leader>cA'] = false,
