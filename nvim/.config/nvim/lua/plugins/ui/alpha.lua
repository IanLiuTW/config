...
local function alpha_dashboard_layout()
  ...
  lazycache.menu = function()
    return {
      ...
      button('<CR>',    '󰑓  Load CWD Session',            '<cmd>SessionLoad<CR>'),
      button('.',       '  Load Last Session',           '<cmd>SessionLoadLast<CR>'),
      button('/',       '󱦞  Select Session',              '<cmd>Telescope persisted<CR>'),
      button('󱁐  󱁐  f', '  Search Files'),
      button('󱁐  󱁐  .', '  Search Recent Files'),
      button('󱁐  󱁐  g', '󰊄  Search with Live Grep'),
      button('g',       '  Open Neogit',                 '<cmd>Neogit<cr>'),
      button('m',       '󰀬  Open Mason',                  '<cmd>Mason<cr>'),
      button(',',       '󰂖  Open Lazy',                   '<cmd>Lazy<cr>'),
