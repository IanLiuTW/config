...
vim.opt.sessionoptions = 'blank,buffers,curdir,folds,help,tabpages,winsize,winpos,terminal,localoptions' -- 'localoptions' so filetype/highlighting restore correctly (auto-session)
